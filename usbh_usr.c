...
#define LCD_ErrLog	printf
#define LCD_UsrLog	printf
#define LCD_DbgLog	printf
...
void USBH_USR_EnumerationDone(void)
{
  ...
  //if(phost->class_cb->Init(&USB_OTG_Core, &USB_Host)== USBH_OK)
  	//LCD_UsrLog("class init done!");
...
int USBH_USR_MSC_Application(void)
{
  ...
  //LCD_UsrLog(">now call USR_MSC_APP!");
  ...
  case USH_USR_FS_DRAW:
    ...
    break;
  case USH_USR_FS_BEGIN:
  case USH_USR_FS_LOGGING:
